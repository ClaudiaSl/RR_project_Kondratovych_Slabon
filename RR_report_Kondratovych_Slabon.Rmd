...
The below graph can easily reflect the situation of Poland in comparison to the European Union countries during timeframe from `r nth(unemp_analysis_date, -3)` to `r nth(unemp_analysis_date, -15)`. 
